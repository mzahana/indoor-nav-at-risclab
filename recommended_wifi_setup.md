...
* Connect the FTDI/USB cable to the ESP module. The orange cable (TX) is connected to (RX) pin on the module. Yellow (RX) is connected to (TX) pin on the module. Connect the power (red) and ground (black).
* 
<div class="info">
Follow the
