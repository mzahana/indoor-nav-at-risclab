...
Objects are considered rigid bodies in the Mocap system. They can be stationary or moving. There are 2 main information a rigid body (object) has in the ```mocap```
