...
set IP gateway (usually this is your router IP). You can set up dynamic IP firt, and then connect to the WiFi. Then, on the WiFi module command line type `get ip` to see the *gateway* and the *netmask*
```sh
